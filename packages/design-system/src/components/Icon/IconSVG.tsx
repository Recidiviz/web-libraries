...
IconSVG.NeedsEmployment = () => (
  <BaseSVG viewBox="0 0 24 24">
    <path
      d="M2 24h20a1 1 0 001-1v-3H1v3a1 1 0 001 1zM23 4h-6V1a1 1 0 00-1-1H8a1 1 0 00-1 1v3H1a1 1 0 00-1 1v12a1 1 0 001 1h22a1 1 0 001-1V5a1 1 0 00-1-1zM9 2h6v2H9V2zm7 13H8v-4h8v4z"
      fill={prop("fill")}
    />
  </BaseSVG>
);
...
IconSVG.NeedsRiskAssessment = () => (
  <BaseSVG viewBox="0 0 22 24">
    <path
      d="M21 0H1a1 1 0 00-1 1v22a1 1 0 001 1h20a1 1 0 001-1V1a1 1 0 00-1-1zm-2 21H3V3h3v3h3a2 2 0 114 0h3V3h3v18z"
      fill={prop("fill")}
    />
    <path d="M5 9h12v3H5V9zM5 14h12v3H5v-3z" fill={prop("fill")} />
  </BaseSVG>
);
